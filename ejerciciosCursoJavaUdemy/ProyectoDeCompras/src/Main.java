...
Se requiere crear la clase OrdenCompra con los siguientes campos privados: identificador
 tipo Integer autoincremental, descripcion String, fecha tipo Date, cliente del tipo
 Cliente y finalmente un atributo de tipo arreglo de productos con 4 elementos:
  Producto[] productos.

  * identificador (Integer) [ ]
  * descripcion (String) [ ]
  * cliente (tipo Cliente) [ ]
  * arreglo de productos con 4 elementos [ ]
...
String y precio int, inicializar todos sus valores en el constructor e implementar
